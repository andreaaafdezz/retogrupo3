...
public class GeneradorPreguntas {
        ...
        public void generarAlgebra(){
            ...
            preguntas.add(new Pregunta("¿Qué propiedad muestra a + b = b + a? /n"
                    + "a) conmutativa"
                    + "b) distributiva"
                    + "c) igualación"
                    + "d) asociación", "a"));
            ...
            preguntas.add(new Pregunta("¿Qué significa 'distribuir' en álgebra? /n"
                    + "dividir cada término dentro del paréntesis /n"
                    + "multiplicar cada término dentro del paréntesis /n"
                    + "restar cada término dentro del paréntesis /n"
                    + "repartir cada término dentro del paréntesis /n", "b"));
            ...
            preguntas.add(new Pregunta("¿Qué es una expresión algebraica? /n"
                                + "a) Una combinación de sumas. /n"
                                + "b) Una combinación de números. /n"
                                + "c) Una combinación de números, variables y operaciones. /n"
                                + "d) Una refran relacionado con la algebra", "c"));   
                    }
